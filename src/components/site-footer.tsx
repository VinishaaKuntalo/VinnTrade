      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-wrap gap-4 text-xs text-slate-400">
            <Link href="/#pulse" className="hover:text-slate-200">
              MCI
            </Link>
            <Link href="/#globe" className="hover:text-slate-200">
              Map
            </Link>
            <Link href="/signals" className="hover:text-slate-200">
              Signals
            </Link>
            <Link href="/stocks" className="hover:text-slate-200">
              Risk browser
            </Link>
            <Link href="/portfolio" className="hover:text-slate-200">
              Portfolio
            </Link>
            <Link href="/#how" className="hover:text-slate-200">
              How we help
            </Link>
